...
class Pokemon {
    ...
    factory Pokemon.fromMap(Map<String, dynamic> json) => Pokemon(
        pokemon: List<PokemonElement>.from(json["pokemon"].map((x) => PokemonElement.fromMap(x))),
    );
...
class PokemonElement {
    ...
    factory PokemonElement.fromJson(String str) => PokemonElement.fromMap(json.decode(str));
